...
var Route$1 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "A quiet daily habit journal — check off rituals, keep streaks, and watch the month fill in."
			},
			{
				name: "theme-color",
				content: "#f3efe6"
		...
		links: [
			...
			{
				rel: "stylesheet",
				href: "https://fonts.googleapis.com/css2?family=Figtree:ital,wght@0,400;0,500;0,600;0,700;1,500&family=Newsreader:ital,opsz,wght@0,6..72,400;0,6..72,500;0,6..72,600;1,6..72,400;1,6..72,500;1,6..72,600&display=swap"
			},
			{
				rel: "stylesheet",
				href: styles_default
